...
+-------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Elimination**   | Biliary (no dosing adjustement for renal impairment)                                                                                                                           |
+-------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
-   \+ Coombs (rare), neutropenia (rare), eosinophilia (22%), thrombocytopenia (rare), *C. difficile* colitis (rare), increased LFTs, headache (rare), confusion (rare), acute interstitial nephritis (less than methicillin)

-   Hepatic dysfunction may occur with dose of ≥12 gm/day.
