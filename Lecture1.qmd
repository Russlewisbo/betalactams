...
## Lecture 3: β-lactams and β-lactamase inhibitors {background-image="images/flemming1.png" background-opacity="0.2"}
...
-   **β-lactam antibiotics exhibit relatively concentration-independent killing**
    ...
    -   Related to mechanism of action: acylation of their targets, the peneicillin-binding proteins
...
![](images/seizues.png){fig-align="center" width="600"}
...
-   Most serious reaction is immediate IgE-mediated anaphylaxis- incidence only 0.05% but 5-10% cases are fatal. 
    -   Other IgE-mediated reactions: urticaria, angioedema, laryngeal edema, bronchospasm

    -   Morbilliform rash after > 72 hours is not (type I) IgE-mediated and often not treatment-limiting (most are benign Type IV reactions)
...
## Clinical role of natural penicillins
...
-   Flucloxacillin (also dicloxacillin?) activates the pregnane X receptor (PXR), which can induce the expression of CYP450 and UGT enzymes, and P-gP transporters
    ...
    ![](images/clipboard-1261899633.png){width="700"}
...
## Reconsideration of Role of anti-staphylcococal penicillins: The SNAP Trial {.smaller}

::::: columns
::: {.column width="70%"}
-   Does the better safety profile of cefazolin outweigh the theoretically superior in vitro activity of anti-staphylococcal penicillins (nafcillin, oxacillin, flucloxacillin) in the setting of high bacterial burden — the so-called “inoculum effect”
-   Can we trust penicillin susceptibility testing when the lab reports an MSSA isolate is penicillin sensitive.
-   **Results from cefazolin study:**
...
::: {.column width="30%"}
<br> <br> ![](images/Screenshot%202025-04-25%20at%2011.20.51.png){fig-align="center"}
:::
:::::
...
-   **Gram-positive bacteria:**
    -   Many *Streptococcus* species, including *Streptococcus pneumoniae* and *Streptococcus pyogenes* (Group A Strep).
    -   *Enterococcus* species, such as *Enterococcus faecalis*.
    -   Non-beta-lactamase-producing *Staphylococcus* species (though many staphylococci produce beta-lactamase, which makes them resistant to aminopenicillins).

2.  **Gram-negative bacteria:**
    -   *Haemophilus influenzae* (non-beta-lactamase-producing strains).
    -   E*scherichia coli* (non-beta-lactamase-producing strains).
    -   *Proteus mirabilis*.
    -   *Salmonella* and *Shigella* species.
    -   *Neisseria meningitidis* and some strains of *Neisseria gonorrhoeae.*
3.  **Anaerobes:**
    -   Some coverage against anaerobic bacteria, but less effective than drugs specifically targeting anaerobes.

## Ambler classification of beta-lactamases {.smaller}

<br>

Clavulanic acid and sulbactam are suicide inhibitors of some Ambler class A enzymes
...
-   **Intrinsic (e.g., 1st-generation BLIs don’t work against AmpC or Carbapenemases)**

-   **BLI-R beta lactamases (point mutation —\> decreased binding of 1st-gen BLIs)**
...
-   **Hyperproduction of beta-lactamase (more common)**
    ...
    -   E.g. ESBL *E.coli*, or *Klebsiella spp.* SHV-1
...
+-------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Absorption**          | Ampicillin (IV) <br> Ampicillin-sulbactam (IV) <br> Amoxicillin (oral, 80% bioavail, dose-depedent) <br> Amoxicillin-clavulanate (oral 80% bioavail., IV) |
+-------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------+
...
|                         |                                                                                                                                                           |
|                         | -   Amoxicillin 500-1000 mg TID-QID; ER tab 775 mg once daily; <br>                                                                                       |
|                         |                                                                                                                                                           |
...
|                        |                                                                                                          |                                                                                                                                                                               |                                                      |
|                        | ESBL , OXA-53 but infrequently used clinically because of higher reported failure rates vs. IV therapies | -   ESBL                                                                                                                                                                      | -   ESBL • OXA-2,32                                  |
|                        |                                                                                                          |                                                                                                                                                                               |                                                      |
|                        |                                                                                                          | -   Intrinsically active against *Acinetobacter baumannii* <br>(directly inhibits PBP1a/b & PBP3). <br> Also against *N. gonorrhoea* + *B. fragilis* but not used clinically. |                                                      |
+------------------------+----------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------+
...
-   Plasma amoxicillin exposures are generally linear and proportional at doses up to 750 mg, after which absorption becomes saturated and bioavailability decreases from approximately 60% at 750 mg to approximately 55% at 875 mg or 1000 mg and to approximately 35% at 2000 mg
    ...
    -   **High dose (Enterbacterales, BSI):** (0.875 g amoxicillin + 0.125 g clavulanic acid) TID-QID
    -   **High dose IV (Enterbacterales, BSI):** (2 g amoxicillin + 0.2 g clavulanic acid) q8h
...
-   Persons with infectious mononucleosis, i.e., Epstein-Barr virus (EBV), are likely to develop rash.

    -   t is not a permanent allergy

-   In patients with true amoxicillin allergy, there is increased risk of cross allergenicity with oral cephalosporins that have an identical R1 side chain: i.e., cefadroxil and cefprozil
...
-   **Amoxicillin/clavulanate is used for upper and lower respiratory tract infections when beta-lactamase–producing organisms are found or suspected**
    -   It can also be useful for UTIs when resistance to other drugs is seen, but it [should not]{.underline} be given for a short 3-day course, as with fluoroquinolones or TMP/SMX given higher failure rate
...
-   **Broad Gram-negative coverage:** Effective against a wide range of Gram-negative bacteria, including *Pseudomonas aeruginosa, Enterobacter species*, and *Escherichia coli*, as well as many *Klebsiella*, *Salmonella*, and *Shigella* species.

-   **Gram-positive bacteria:** Active against many Gram-positive organisms, such as *Streptococcus pneumoniae* and other *Streptococcus* species, and some penicillin-sensitive *Staphylococcus aureus* (MSSA), but not effective against methicillin-resistant *Staphylococcus aureus* (MRSA).

-   **Anaerobic bacteria:** Offers good coverage against anaerobes, including *Bacteroides fragilis* and other *Bacteroides* species, making it useful for intra-abdominal and pelvic infections.
...
|                         | -   \>100% bile:serum                                                                                                                    |
|                         |                                                                                                                                          |
|                         | -   CSF:blood penetration- limited data                                                                                                  |
+-------------------------+------------------------------------------------------------------------------------------------------------------------------------------+
| **Metabolism**          | -   No metabolism                                                                                                                        |
|                         |                                                                                                                                          |
|                         | -   t½ 1 hr                                                                                                                              |
+-------------------------+------------------------------------------------------------------------------------------------------------------------------------------+
| **Elimination**         | Renal, may interfere with SeCr excretion (false nephrotoxicity signal)                                                                   |
+-------------------------+------------------------------------------------------------------------------------------------------------------------------------------+
| **PK:PD target**        | ≥ 40-50% *f*Time~\>MIC~                                                                                                                  |
+-------------------------+------------------------------------------------------------------------------------------------------------------------------------------+
...
![](images/bling4.png){fig-align="center" width="700"}
...
-   **Drug-induced immune thrombocytopenia**
    -   Platelet dysfunction reported more frequently in patients with renal failure
-   **Treatment stopped due to adverse effects: (3.2%)**
    -   Local phlebitis (1%), fever (2%), rash (4%)
    -   Serum sickness, positive Coombs, neutropenia, eosinophilia, thrombocytopenia, increased PT/PTT
    -   Nausea/vomiting (7%), diarrhea (11%)
    -   *C. difficile* colitis
    -   Increased LFTs, increased BUN/Creatinine, headache (8%), confusion (rare), seizures (rare), hypokalemia
...
![](images/aztreonam.png){fig-align="center" width="300"}

## Aztreonam: Spectrum of activity

<br> <br>

-   Only gram-negative with some *P. aeruginosa* coverage (high resistance rates in some institutions)
-   No useful activity against gram-positive bacteria or anaerobes
-   Degraded by Class A and C beta-lactamases

## Is aztreonma truly safe for penicillin allergic patients? {.smaller}

::::: columns
::: {.column width="40%"}
![](images/sidechains.png){fig-align="right" width="200"}
:::
...
![](images/comingsoon.png){fig-align="center" width="500"}
...
-   No benefit for MBL-producing *P. aeruginosa*

## Pharmacokinetics of aztreonam {.smaller}
...
| **Absorption**          | IV only                                                                   |
+-------------------------+---------------------------------------------------------------------------+
| **Distribution**        | -   Aztreonam 0.28 L/kg, 38% protein binding                              |
...
| **PK:PD target**        | ≥ 40-50% *f*Time~\>MIC~                                                   |
+-------------------------+---------------------------------------------------------------------------+
| **Typical adult doses** | -   2 grams IV q6-8h                                                      |
|                         |                                                                           |
...
## Summary-Pencillins {background-image="images/flemming1.png" background-opacity="0.1"}

<br>

-   For select pathogens, still some of the rapidly killing agents
-   Short t½ = not the most practical agents
-   Time \> MIC pharmacodynamics, + short t½= activity will be maximized with prolonged infusions
